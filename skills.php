...
<div class="page-content-container d-flex container-fluid justify-content-center align-items-center">
    <div class="window retro-border mb-5">
        ...
        <div class="skills-content container-fluid mt-3">
            ...
            <div class="row mt-3 mb-3">
                ...
                while ($query->have_posts()) {
                    $query->the_post(); ?>
                    <div class="col-lg d-flex mb-sm-3">
            ...
            <div class="skills-in-progress container-fluid">
